...
export const WatchTower: React.FC = () => {
  ...
  return (
    <>
      <HelmetMetaTag
        title="Connect to a WatchTower | LightningBoost"
        description="Keep your funds safe connecting to a WatchTower. If you don't run your node 24/7, consider connecting to my WatchTower service for free and be safe."
        keywords="lightning network, watchtower, safe"
      />
        ...
        <div style={{ padding: 24 }}>
          <Grid container spacing={6}>
            <Grid item xs={12} container spacing={2}>
              ...
              <Grid item xs={12}>
                <Typography align="center">
                  ...
                  breach, offering greater degree of safety to channel funds.
                  The watchtower node will monitor the Lightning Network channel
                  for breaches; if it notices one, the watchtower will launch a
                  “penalty” transaction that will return the funds to the
                  offline node.
                </Typography>
              </Grid>
            </Grid>
            <Grid item xs={12} container spacing={2}>
              ...
              <Grid item xs={12}>
                <Typography align="center">
                  In order to set up a watchtower client, you’ll need two
                  things:
                  <br />
                  <br />
            ...
            <Grid item xs={12}>
              <Typography align="center">
                That&apos;s it! As long as my node is connected and observing
