  ...
  return (
    <Paper className={classes.paper}>
      <Grid container>
        ...
        <Grid item>
          <Typography>
            Did you ever want to know how much you would have now investing in
            bitcoin instead of that investment you made? You can compare here a
            one time investment or a DCA (dollar cost average) type of
            investment
          </Typography>
        </Grid>
      </Grid>
